...
class controlador_adm_session extends \gamboamartin\controllers\controlador_adm_session {
    ...
    public string $link_lista_nom_conf_abono = '';
    ...
    public function inicio(bool $aplica_template = false, bool $header = true, bool $ws = false): string|array
    {
        ...
        $hd = "index.php?seccion=nom_conf_abono&accion=lista&session_id=$this->session_id";
        $this->link_lista_nom_conf_abono = $hd;
        ...
        $hd = "index.php?seccion=nom_proceso_nomina&accion=lista&session_id=$this->session_id";
        $this->link_lista_nom_proceso_nomina = $hd;
