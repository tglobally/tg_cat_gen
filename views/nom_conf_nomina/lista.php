        ...
        <div class="col-md-12 mt-3 table-responsive-sm">
            ...
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <th><?php echo $registro->nom_conf_nomina_id; ?></th>
                    <th><?php echo $registro->nom_conf_nomina_codigo; ?></th>
                    <th><?php echo $registro->nom_conf_nomina_descripcion; ?></th>
                    <th><?php echo $registro->nom_conf_nomina_descripcion_select; ?></th>
                </tr>
                <?php } ?>
