        ...
        <div class="col-md-12 mt-3 table-responsive-sm">
            ...
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <th data-breakpoints="xs md" class="control"  data-type="html" data-filterable="false">Asigna Percepcion</th>
                ...
                <?php foreach ($controlador->registros as $registro) {?>
                    <tr>
                        <td><?php echo $registro->nom_conf_nomina_id; ?></td>
                        <td><?php echo $registro->nom_conf_nomina_codigo; ?></td>
                        <td><?php echo $registro->nom_conf_nomina_codigo_bis; ?></td>
                        <td><?php echo $registro->nom_conf_nomina_descripcion; ?></td>
                        <td><?php echo $registro->nom_conf_nomina_descripcion_select; ?></td>
                        <td><a class="btn btn-warning " href="<?php echo $registro->link_asigna_percepcion; ?>">Asigna Percepcion</a></td>
