...
<?php include 'templates/nom_conf_empleado/lista/secciones.php'; ?>
        ...
        <div class="col-md-12 mt-3 table-responsive-sm">
            ...
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <th><?php echo $registro->nom_conf_empleado_id; ?></th>
                    <th><?php echo $registro->nom_conf_empleado_codigo; ?></th>
                    <th><?php echo $registro->nom_conf_empleado_descripcion; ?></th>
                    <th><?php echo $registro->nom_conf_empleado_descripcion_select; ?></th>
                </tr>
                <?php } ?>
